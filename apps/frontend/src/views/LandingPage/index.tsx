...
import { Target, Search, Link2, BarChart3, Shield, Rocket, ArrowRight, Play, Menu, X, CheckCircle, AlertTriangle, Loader2, Layers, GitBranch, FileText, Settings, Zap, Globe } from 'lucide-react';
