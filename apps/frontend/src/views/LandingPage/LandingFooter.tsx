...
export function LandingFooter() {
  return (
    <footer className="bg-surface-primary border-t border-border py-12 px-4" role="contentinfo">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              {socialLinks.map(({ label, icon: Icon, href }) => (
                <a key={label} href={href} className="text-text-tertiary hover:text-text-primary transition-colors rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500" aria-label={label}>
